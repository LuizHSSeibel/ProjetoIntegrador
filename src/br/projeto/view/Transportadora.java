...
public class Transportadora extends javax.swing.JFrame {
    ...
    private void adicionar(){
        String sql = "insert int transporte(nome,destino,rastreador,distancia) values (?, ?, ?, ?)";
        ...
        try {
            ...
            if (txtNome.getText().isEmpty() || 
                ...
                JOptionPane.showMessageDialog(null, "Nome, Rastreador ou destino não inseridos");
                
            }else {
                int adcionado = ps.executeUpdate();
                if (adcionado>0) {
                    JOptionPane.showMessageDialog(null,"Transporte adicionado com sucesso!");
    ...
    private void pesquisar(){
        String sql = "select nome as Nome, destino as Destino, rastreador as Rastreador, distancia as Distancia from transporte where nome like ?";
    ...
    private void carregaDadosCadastro(){
        String sql = "select nome as Nome, destino as Destino, rastreador as Rastreador, distancia as Distancia from transporte";
     ...
     private void alterarDados(){
        String sql = "update transporte set nome = ?, destino = ?, rastreador = ?, destino = ? where nome = ?";
    ...
    private void remover(){
       ...
       String sql = "delete from transporte where nome = ?";
        ...
        try {
            ...
            if (apagar>0){
                JOptionPane.showMessageDialog(null, "Transporte removido");
                txtNome.setText(null);
                txtDestino.setText(null);
                txtRastreador.setText(null);
                txtDistancia.setText(null);
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Nome do Motorista");
        ...
        tbLista.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Destino", "Rastreador", "Distância"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Transportadora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Transportadora().setVisible(true);
            }
        });
    }
